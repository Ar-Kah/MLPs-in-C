...
__global__ void safe_softmax_kernel(double* input, int size, double* output, int stride);
...
__global__ void backward_kernel_output_layer(double* grad_wrt_b, double* grad_wrt_w, double* previous_grad_wrt_input,
